...
#     res = -1
#     for c in C_range:
#         temp = SVC(C=c,kernel='linear')
#         perf = cv_performance(temp,X,y,kf,metric)
#         print("score for c {} and metric {}: {}".format(c,metric,perf))
#         if perf > best:
#             res = c 
#             best = perf
#     return res
...
#     k_fold = StratifiedKFold(train_y,n_folds=5)
#     # part 2: for each metric, select optimal hyperparameter for linear-kernel SVM using CV
#     # for metric in metric_list:
#     #      best = select_param_linear(train_X,train_y,k_fold,metric)
#     #      print('best for {} is {}'.format(metric,best))

        
#     # part 3: train linear-kernel SVMs with selected hyperparameters
#     best_clf = SVC(10.0,kernel='linear')
#     best_clf.fit(train_X,train_y)


#     # part 3: report performance on test data
#     for metric in metric_list:
#         score = performance_test(best_clf,test_X,test_y,metric)
#         print('for metric {}: the performance on test data is {}'.format(metric,score))
